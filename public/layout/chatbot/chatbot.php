...
createChat({
    ...
    i18n: {
        en: {
            /* Se pone 'en' aunque sea español porque sobrescribe el idioma base */
            title: "Yuna IA ",
            /* El título grande "Hi there!" */
            subtitle: "Estamos aquí para servirte las 24 horas.",
            /* El texto de abajo */
            footer: "Gobierno Municipal 2024-2027",
            /* Texto pequeño al pie (opcional) */
            inputPlaceholder: "Escribe tu duda aquí...",
            /* El texto de la barra de escribir */
        },
    },
});
</script>